...
//        });
        ...
        try {
            ...
            System.out.println("The default port is " + SerialPort.getDefaultPort());
            System.out.println("Connecting to /dev/ttyUSB0");
            ...
            for (int i = 0; i < 10; i++) {
                ...
                final int available = serial.available();
                if (available > 0) {
                    final byte[] read = serial.read(available);
